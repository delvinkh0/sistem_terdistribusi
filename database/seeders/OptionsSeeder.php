...
class OptionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data=[
            ...
            // [ 'option_name' => 'Banyak aspek', 'value' => 1 ],
            // [ 'option_name' => 'Hampir setiap aspek', 'value' => 2],
            // [ 'option_name' => 'Setiap aspek', 'value' => 3],
            // [ 'option_name' => 'Tidak kehilangan martabat saya', 'value' => 0 ],
            // [ 'option_name' => 'Kehilangan sedikit martabat saya', 'value' => 1 ],
            // [ 'option_name' => 'Kehilangan cukup banyak martabat saya', 'value' => 2 ],
            // [ 'option_name' => 'Total kehilangan martabat saya', 'value' => 3 ],
            [ 'option_name' => 'Benar', 'value' => 0],
            [ 'option_name' => 'Salah', 'value' => 1],
            [ 'option_name' => 'Setuju', 'value' => 1],
            [ 'option_name' => 'Tidak Setuju', 'value' => 0],
