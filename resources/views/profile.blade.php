    ...
    <section id="profile" class="container">
        <div class="part profile-part">
            <div class="title-and-button">
                ...
                <button type="submit" class="show-modal edit-profile-modal" value="Edit" onclick="editProfileModalToggleOn()">Edit</button>
            </div>
            ...
            <div class="history-tests">
                <a href="#" class="history-test">
                    ...
                    <svg width="345" height="102" viewBox="0 0 345 102" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_377_1605" x1="169" y1="57" x2="176" y2="138" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#FDF0F0" />
                                <stop offset="1" stop-color="#1D2254" />
                            </linearGradient>
                            <linearGradient id="paint1_linear_377_1605" x1="183" y1="71" x2="176" y2="147" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#F1B4BB" />
                                <stop offset="1" stop-color="#1D2254" />
                            </linearGradient>
                            <linearGradient id="paint2_linear_377_1605" x1="183" y1="71" x2="176" y2="147" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#F1B4BB" />
                                <stop offset="1" stop-color="#1D2254" />
                            </linearGradient>
                        </defs>
            ...
            <form action="{{ route('change.password.action') }}" method="post">
                ...
                <div class="form-field">
                    <div class="field">
                        ...
                        <input type="password" name="current_password" id="current_password" placeholder="Masukkan passwordmu saat ini">
                    </div>
                    <div class="field">
                        <label for="new_password">Password baru</label>
                        <input type="password" name="new_password" id="new_password" placeholder="Masukkan password barumu">
                    </div>
                    <div class="field">
                        <label for="confirm_password">Konfirmasi password baru</label>
                        <input type="password" name="confirm_password" id="confirm_password" placeholder="Masukkan kembali password barumu">
                    </div>
                </div>
